...
Shader "MMS3/Mnmrshader3_Transparent"
{
	Properties
	{
		[Enum(UnityEngine.Rendering.CullMode)]_CullMode("Cull Mode", Float) = 2
		_AmbientMinimum("Ambient Minimum", Range( 0 , 1)) = 0
		_Alpha_Musk("Alpha_Musk", 2D) = "white" {}
		...
		_Shade_Matcap_Color("Shade_Matcap_Color", Color) = (0.5882353,0.5882353,0.5882353,1)
		...
		[Toggle]_Shade_Matcap_Alpha("Shade_Matcap_Alpha", Float) = 0
		_Add_Matcap("Add_Matcap", 2D) = "black" {}
		_Add_Matcap_Color("Add_Matcap_Color", Color) = (1,1,1,1)
		[NoScaleOffset]_Add_Matcap_Mask("Add_Matcap_Mask", 2D) = "white" {}
		[Toggle]_Add_Matcap_Alpha("Add_Matcap_Alpha", Float) = 0
		_RimLight_Color("RimLight_Color", Color) = (0.2745098,0.2745098,0.2745098,1)
	...
	SubShader
	{
		...
		uniform float _Add_Matcap_Alpha;
		uniform sampler2D _Add_Matcap;
		uniform sampler2D _NormalMap;
		uniform float4 _NormalMap_ST;
		uniform float _Shade_Matcap_Alpha;
		uniform sampler2D _Shade_Matcap;
		uniform sampler2D _MainTex;
		uniform float4 _MainTex_ST;
		uniform float4 _DiffuseColor;
		uniform sampler2D _Alpha_Musk;
		uniform float4 _Alpha_Musk_ST;
		...
		uniform sampler2D _Add_Matcap_Mask;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float Add_Matcap_A148 = tex2DNode54.a;
			float4 tex2DNode52 = tex2D( _Shade_Matcap, temp_output_67_0.xy );
			float Shade_Matcap_A147 = tex2DNode52.a;
			float2 uv_MainTex = i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw;
			float4 temp_output_16_0 = ( tex2D( _MainTex, uv_MainTex ) * _DiffuseColor );
			float2 uv_Alpha_Musk = i.uv_texcoord * _Alpha_Musk_ST.xy + _Alpha_Musk_ST.zw;
			float clampResult164 = clamp( ( lerp(0.0,Add_Matcap_A148,_Add_Matcap_Alpha) + ( lerp(0.0,Shade_Matcap_A147,_Shade_Matcap_Alpha) + ( temp_output_16_0.a * tex2D( _Alpha_Musk, uv_Alpha_Musk ).r ) ) ) , 0.0 , 1.0 );
			float Alpha155 = clampResult164;
			...
			float2 uv_Add_Matcap_Mask58 = i.uv_texcoord;
			float4 lerpResult84 = lerp( float4( 0,0,0,0 ) , ( saturate( ( blendOpSrc64 * blendOpDest64 ) )) , tex2D( _Add_Matcap_Mask, uv_Add_Matcap_Mask58 ));
			...
			float4 lerpResult136 = lerp( BaseColor17 , ( saturate( lerpBlendMode118 )) , tex2D( _Shade_Matcap_Mask, uv_Shade_Matcap_Mask135 ));
...
/*ASEBEGIN
Version=17101
166;405;1216;517;-945.15;1449.444;1;True;True
...
Node;AmplifyShaderEditor.SamplerNode;66;-3273.448,-2240.764;Inherit;True;Property;_NormalMap;Normal Map;7;1;[Normal];Create;True;0;0;False;0;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-2511.609,-2050.961;Float;False;Property;_RimLight_Power;RimLight_Power;24;0;Create;True;0;0;False;0;0;0.6;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;156;-1853.477,-699.6858;Inherit;False;1791.567;919.4097;;18;151;152;150;154;153;149;146;107;106;105;104;17;16;14;15;164;167;161;Basecolor;0.3049396,0.9528302,0,1;0;0
...
Node;AmplifyShaderEditor.ColorNode;14;-1660.957,12.72389;Float;False;Property;_DiffuseColor;Color;6;0;Create;False;0;0;False;0;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;15;-1753.477,-186.7982;Inherit;True;Property;_MainTex;MainTex;5;0;Create;False;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;1;-3342.618,-2984.137;Inherit;False;1869.626;445.3056;Copyright (c) 2018 Reflex  Released under the MIT license;13;13;10;9;7;6;5;4;3;21;22;23;157;160;Lighting;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-2217.534,-1982.874;Float;False;Property;_RimLight_Blur;RimLight_Blur;25;0;Create;True;0;0;False;0;5;3;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-1961.244,-1177.682;Float;False;Property;_Shade_Matcap_Min;Shade_Matcap_Min;15;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;52;-1983.355,-1389.961;Inherit;True;Property;_Shade_Matcap;Shade_Matcap;10;0;Create;True;0;0;False;0;ece969dbfb97d446ba8f8358a78789b5;ece969dbfb97d446ba8f8358a78789b5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-1956.399,-1104.45;Float;False;Property;_Shade_Matcap_Max;Shade_Matcap_Max;16;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;56;-1328.534,-1382.925;Float;False;Property;_Add_Matcap_Color;Add_Matcap_Color;19;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;26;-1650.21,-1040.139;Float;False;Property;_Shade_Matcap_Color;Shade_Matcap_Color;11;0;Create;True;0;0;False;0;0.5882353,0.5882353,0.5882353,1;0.5882353,0.5882353,0.5882353,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;74;-1596.122,-1986.194;Inherit;True;Property;_RimLight_Mask;RimLight_Mask;23;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;45;-1876.07,-1979.493;Float;False;Property;_RimLight_Color;RimLight_Color;22;0;Create;True;0;0;False;0;0.2745098,0.2745098,0.2745098,1;0.5882353,0.5882353,0.5882353,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;54;-1635.703,-1546.084;Inherit;True;Property;_Add_Matcap;Add_Matcap;18;0;Create;True;0;0;False;0;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;119;-1411.008,-960.1365;Float;False;Property;_BassColor_HardLight;BassColor_HardLight;13;0;Create;True;0;0;False;0;0.3;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;58;-1061.891,-1381.015;Inherit;True;Property;_Add_Matcap_Mask;Add_Matcap_Mask;20;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-2579.601,-2750.249;Float;False;Property;_AmbientMinimum;Ambient Minimum;2;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;72;-552.4316,-1554.88;Inherit;False;17;BaseColor;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;121;-1088.625,-945.6472;Float;False;Property;_BassColor_Add;BassColor_Screen;14;0;Create;False;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;161;-1260.619,9.572498;Inherit;True;Property;_Alpha_Musk;Alpha_Musk;3;0;Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;77;-929.4236,-2084.498;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;167;-918.9722,-175.1802;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;153;-1125.783,-369.4604;Inherit;False;Property;_Shade_Matcap_Alpha;Shade_Matcap_Alpha;17;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;81;-792.8467,-2094.531;Float;False;RimLight;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SaturateNode;10;-2054.254,-2896.253;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;136;-440.907,-1165.624;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;154;-697.5918,-389.5416;Inherit;False;Property;_Add_Matcap_Alpha;Add_Matcap_Alpha;21;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;151;-765.2877,-284.1713;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;104;-1746.138,-599.6858;Inherit;True;Property;_EmissionMap1;Emission;8;0;Create;False;0;0;False;0;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;105;-1691.056,-398.6626;Float;False;Property;_Emission_Color;Emission_Color;9;0;Create;True;0;0;False;0;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;164;-228.8129,-394.8736;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;155;91.17529,-391.7081;Inherit;False;Alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;102;-3144.338,-90.18736;Inherit;True;Property;_Outline_Mask;Outline_Mask;29;1;[NoScaleOffset];Create;True;0;0;False;0;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-1642.687,-2745.094;Float;False;Property;_CullMode;Cull Mode;1;1;[Enum];Create;True;0;1;UnityEngine.Rendering.CullMode;True;0;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;168;1585.15,-1199.444;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;160;-1946.794,-2732.853;Float;False;Property;_ZWriteMode;Z Write Mode;4;1;[Enum];Create;True;2;On;1;Off;0;0;True;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;97;-3332.975,-466.1384;Float;False;Property;_Outline_Color;Outline_Color;26;0;Create;True;0;0;False;0;0.2941176,0.2941176,0.2941176,1;0.2941176,0.2941176,0.2941176,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;131;-2911.692,-578.7159;Inherit;False;Property;_BaseColor_Mix;BaseColor_Mix;27;0;Create;True;0;0;False;0;1;2;0;FLOAT3;1,1,1;False;1;FLOAT3;1,1,1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-3173.041,-197.2671;Float;False;Property;_Outline_Width;Outline_Width;28;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;158;1363.294,-1329.023;Inherit;False;155;Alpha;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1756.146,-1452.237;Float;False;True;2;ASEMaterialInspector;0;0;CustomLighting;MMS3/Mnmrshader3_Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;True;160;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Transparent;;Transparent;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;3;1;False;-1;10;False;-1;3;1;False;-1;10;False;-1;1;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;True;157;-1;0;False;159;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;167;0;146;3
WireConnection;167;1;161;1
...
WireConnection;0;9;158;0
WireConnection;0;13;168;0
ASEEND*/
//CHKSM=1C46AA996A68F28DD31021C76DC8D15CF891C017